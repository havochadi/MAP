...
**Next Plan 2b task** (not part of this plan — separately planned): the remaining detail pages with dynamic route params (`/venues/[venueId]`, `/classes/[classId]`, `/coaches/[coachId]`), `/payroll`, `/classes/new`, `/classes/[classId]/attendance`, `/coaches/new`.
